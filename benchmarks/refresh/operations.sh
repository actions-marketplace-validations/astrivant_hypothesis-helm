...
case "$stage" in
  ...
  prepare-fixtures)
    ...
    ;;
  performance | discovery | bug-density | sparsity | structure-sparsity | structural-sparsity | matrix | pca | expansion | structure-depth | nesting | stress | sampling | sensitivity | calibration-variation | filtering | error-surface)
