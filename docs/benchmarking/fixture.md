...
[Benchmarking](README.md) · [Chart](../../pkg/hypothesis_helm_benchmarking/assets/chart)
...
The [combined stress parameters](../../pkg/hypothesis_helm_benchmarking/assets/chart/benchmark-parameters.yaml)
...
Other studies select profiles of this same generator: [normal quantiles](../../pkg/hypothesis_helm_benchmarking/assets/fixture/standard.yaml),
[gated resources](../../pkg/hypothesis_helm_benchmarking/assets/fixture/topology.yaml), individual topology categories, mixed depths, and
seeded faults. Their existing distribution and fault controls remain available.

```sh
hypothesis-helm-benchmark --parameters pkg/hypothesis_helm_benchmarking/assets/fixture/standard.yaml \
