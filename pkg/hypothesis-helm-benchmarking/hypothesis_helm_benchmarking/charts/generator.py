...
from hypothesis_helm_benchmarking.charts.mixtures import normalized_weights, write_mixture
...
from hypothesis_helm_benchmarking.charts.stress import SIGNALS, Stress, write_stress
...
def reproduce(source: Path, output: Path, *, force: bool = False, workspace: FixtureWorkspace | None = None) -> dict[str, object]:
    ...
    from hypothesis_helm_benchmarking.charts.fixture import chart_path
    ...
    if "structural_sparsity" in operations:
        from hypothesis_helm_benchmarking.charts.structural_sparsity import configure
    ...
    if "error_surface" in operations:
        from hypothesis_helm_benchmarking.charts.error_surface import configure_surface
    ...
    if "output_shape" in operations:
        from hypothesis_helm_benchmarking.charts.shape import reshape_faults
    ...
    if "nested_inputs" in operations:
        from hypothesis_helm_benchmarking.charts.ordering import nest_inputs

        nest_inputs(output, workspace=workspace)
