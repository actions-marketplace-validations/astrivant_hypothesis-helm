...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if args.resume is not None:
            ...
            return 0
        project = Path.cwd()
        if not (project / "pkg/hypothesis-helm-benchmarking/hypothesis_helm_benchmarking/refresh/recipes/operations.sh").is_file():
        ...
        if args.ci_phase:
            from hypothesis_helm_benchmarking.refresh.ci import phase_operations, run_phase
