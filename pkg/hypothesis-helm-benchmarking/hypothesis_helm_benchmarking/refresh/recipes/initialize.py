...
hashes = {}
packages = (
    Path("pkg/hypothesis-helm/hypothesis_helm"),
    Path("pkg/pipeline"),
    Path("pkg/hypothesis-helm-benchmarking/hypothesis_helm_benchmarking"),
    Path("pkg/hypothesis-helm-catalog/hypothesis_helm_catalog"),
)
sources = [
    *(path for package in packages for path in package.rglob("*.py")),
    *Path("pkg/hypothesis-helm-catalog/hypothesis_helm_catalog/data").glob("*.json"),
    *Path("pkg/hypothesis-helm-benchmarking/hypothesis_helm_benchmarking/assets").rglob("*"),
    Path("pkg/hypothesis-helm/hypothesis_helm/execution/calibration.json"),
    Path("pkg/hypothesis-helm/hypothesis_helm/reporting/assets/logo.png"),
]
