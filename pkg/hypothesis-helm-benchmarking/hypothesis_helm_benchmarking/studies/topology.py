...
def analyze(graph: Graph) -> tuple[dict[str, object], dict[str, tuple[float, float]]]:
    ...
    metrics: dict[str, object] = {
        ...
        "interpretation": (
            "Degree counts include parallel edges. DAG depth measures dependency-chain length. "
            "Geometry describes the layout. Reachability records potential influence; causal effects require further analysis."
        ),
    }
