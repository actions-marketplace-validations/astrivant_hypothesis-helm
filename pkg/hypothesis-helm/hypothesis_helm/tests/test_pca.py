...
import numpy as np
import pytest
from hypothesis_helm_benchmarking.analysis.pca import inject_errors, manifest_features, project
...
def test_deadline_saves_no_partial_pca(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("hypothesis_helm_benchmarking.studies.pca.render", expired)
