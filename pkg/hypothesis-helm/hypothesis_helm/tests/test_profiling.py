...
from hypothesis_helm_benchmarking.execution.profiling import PROFILE_DIRECTORY, StackProfiler, capture
...
def test_ci_process_id_collisions_stay_separate(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("hypothesis_helm_benchmarking.reporting.flamegraph.plot", Mock(return_value=1.0))
