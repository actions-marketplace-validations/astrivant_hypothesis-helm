...
from hypothesis_helm.schemas.generation.combinations import InteractionPlan, trim_values
    ...
    *,
    ...
    if full_plan is not None:
        ...
        full = {
            ...
            "heuristic_basis": ("heuristic estimate from the progressive union filtering ratio and raw input upper bound"),
        }
