...
import pytest
from hypothesis_helm_benchmarking.charts.error_surface import ErrorPopulation, configure_surface, surface_manifests
...
from hypothesis_helm_benchmarking.studies.error_surface import METHODS, main, verify
...
def test_surface_endpoints_and_timeout(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    with FixtureWorkspace() as workspace:
        ...
        monkeypatch.setattr("hypothesis_helm_benchmarking.studies.matrix.render", expired)
        row = measure(
            chart,
            spec,
            "default",
...
def test_output_grid(size: str) -> None:
    ...
    """
    from hypothesis_helm_benchmarking.studies.error_surface import RATES, grid_values, output_size
...
def test_invalid_output_grid(size: str) -> None:
    ...
    from hypothesis_helm_benchmarking.studies.error_surface import output_size
