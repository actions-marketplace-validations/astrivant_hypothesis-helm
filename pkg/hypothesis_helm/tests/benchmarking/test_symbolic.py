...
import pytest
from hypothesis_helm_benchmarking.analysis.symbolic import partition, surfaces
...
def test_missing_optional_dependency(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    import hypothesis_helm_benchmarking.studies.symbolic_surface as study
    ...
    monkeypatch.setattr("hypothesis_helm_benchmarking.studies.symbolic_surface.importlib.import_module", missing)
...
def test_source_cannot_be_overwritten(tmp_path: Path) -> None:
    ...
    """
    from hypothesis_helm_benchmarking.studies.symbolic_surface import main
