...
from hypothesis_helm.charts.testing.runner import check_chart, render
...
def test_bitnami_resource_helper(preset_chart: Chart) -> None:
    ...
    """
    source = PROJECT_ROOT / "third_party/bitnami-charts/bitnami/common/templates/_resources.tpl"
