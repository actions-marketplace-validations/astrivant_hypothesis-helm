...
def test_cli_stream_remains_parseable(tmp_path: Path, capfd: pytest.CaptureFixture[str], mode: str, output_format: str) -> None:
    """
    ...
    Args:
        ...
        output_format (str): Requested stream encoding.

    Returns:
        None: Stdout contains complete manifests only, while the report remains on stderr.
    """
