...
import pytest
from hypothesis_helm_benchmarking.studies.topology import Graph, analyze, plot
...
def test_layout_is_stable_across_process_hash_seeds() -> None:
    ...
    script = (
        "import json,sys; from hypothesis_helm_benchmarking.studies.topology import analyze; "
