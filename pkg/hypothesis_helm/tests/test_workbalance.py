...
import pytest
from workbalance import Scheduler, ShortestRemaining, checkpoints
...
def test_feedback_graph_repeats_and_pauses_between_rounds(tmp_path: Path) -> None:
    ...
    """
    from workbalance import FeedbackGraph, Graph
...
def test_shutdown_checkpoints_then_finalizes(tmp_path: Path) -> None:
    ...
    """
    from workgraph import Finalizer, ShutdownContract
...
def test_graph_traversal_dispatch(tmp_path: Path, depth_first: bool) -> None:
    ...
    """
    from workbalance import BreadthFirst, DepthFirst
