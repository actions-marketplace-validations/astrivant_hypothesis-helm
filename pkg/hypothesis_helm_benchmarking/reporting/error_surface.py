...
def plot(output: Path, document: dict[str, object]) -> None:
    ...
    from hypothesis_helm_benchmarking.reporting.response_surface import plot as plot_quadratic
    ...
    from hypothesis_helm_benchmarking.reporting.error_highlight import plot as plot_highlight
