...
def plot(output: Path, document: dict[str, object]) -> None:
    ...
    from hypothesis_helm_benchmarking.reporting.complexity_sweep import plot as plot_sweep
...
def main(argv: list[str] | None = None, *, workspace: FixtureWorkspace | None = None) -> int:
    ...
    if args.plot_only:
        ...
        from hypothesis_helm_benchmarking.analysis.calibration_matrix import plot as plot_matrix
    ...
    if document["status"] != "complete":
        return 1
    from hypothesis_helm_benchmarking.analysis.calibration_matrix import evaluate
