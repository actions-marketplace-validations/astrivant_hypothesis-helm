...
from hypothesis_helm_benchmarking.charts.error_surface import ErrorPopulation, configure_surface
...
from hypothesis_helm_benchmarking.studies.error_surface import METHODS, RATES, save
...
def main(argv: list[str] | None = None, *, workspace: FixtureWorkspace | None = None) -> int:
    ...
    """
    from hypothesis_helm_benchmarking.reporting.response_surface import plot
