...
from hypothesis_helm_benchmarking.charts.stress import FAMILIES, Stress
...
def plot(output: Path, document: dict[str, object]) -> None:
    ...
    finish(
        ...
        output,
        "sampling-recall",
        "Known synthetic defects; recall measured across repeated subsets of real Helm observations.",
    )
    ...
    lines.extend(
        [
            ...
            "The default floor sets a conservative minimum case count. Recall depends on the chart's defect-triggering inputs.",
            "",
