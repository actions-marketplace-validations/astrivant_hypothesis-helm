...
from workgraph import Control, Outcome, ShutdownContract, Statistics, Work
from workgraph.gates import AND, NOT, OR, Signal

from workbalance import BreadthFirst, Scheduler
...
def main() -> int:
    ...
    parser.add_argument("--output", type=Path, default=Path(f".cache/workbalance/example-{time.time_ns()}"))
