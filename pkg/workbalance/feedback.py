...
from workgraph import Control, Outcome, Statistics, Work

from workbalance.graph import Graph
...
class FeedbackGraph:
    ...
    def run(self, control: Control, checkpoint: dict[str, object] | None) -> Outcome:
        ...
        def emit(event: str) -> None:
            ...
            self.notify(f"[workbalance] {self.work.name}: {event} round={iteration}")
