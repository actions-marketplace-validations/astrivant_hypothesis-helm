...
from scripts.benchmark_sparsity import quality
from scripts.benchmarking.structures import STRUCTURES, expected_manifests, valid_assignment
...
def main() -> int:
    ...
    parser.add_argument("--output", type=Path, default=Path("docs/benchmarks/matrix"))
    ...
    from scripts.benchmarking.matrix_plots import plot
