...
from scripts.benchmark_helm import code_digest
from scripts.benchmark_matrix import bundle_key, reference_space
from scripts.benchmarking.pca import inject_errors, project
from scripts.benchmarking.structures import STRUCTURES, configmap, expected_manifests
...
def run_case(
    ...
    spec = generate(path, input_complexity=complexity, output_bins=4, structure=structure)
...
def main() -> int:
    ...
    parser.add_argument("--output", type=Path, default=Path("docs/benchmarks/pca"))
    ...
    from scripts.benchmarking.pca_plots import plot
