...
- [prometheus/prometheus-adapter](#prometheusprometheus-adapter)
<!-- toc:end -->

[All chart topologies](../../README.md)

Status: **rendered**. Source: `third_party/prometheus-community-helm-charts/charts/prometheus-adapter`.
