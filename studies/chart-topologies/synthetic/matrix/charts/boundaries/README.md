# synthetic/matrix/charts/boundaries

<!-- toc:start -->
**Table of contents**

- [synthetic/matrix/charts/boundaries](#syntheticmatrixchartsboundaries)
<!-- toc:end -->

[All chart topologies](../../../../README.md)

Status: **rendered**. Source: `.cache/refresh/refresh-1789617223/outputs/matrix/cases/boundaries.yaml`.
